  ...
  <view class="detail-container">
    <view class="sub-container">
      ...
      <view class="prize-box">
        ...
        <view class="info-box">
          <view class="">我走路带风</view>
          <view class="">NO.123</view>
          <view class="">200元</view>
        </view>
      ...
      <view class="prize-box">
        ...
        <view class="info-box" v-for="i in 3">
          <view class="">我走路带风</view>
          <view class="">123</view>
          <view class="">3000元</view>
        </view>
      ...
      <view class="prize-box">
        ...
        <view class="info-box" v-for="i in 10">
          <view class="">我走路带风</view>
          <view class="">NO.123</view>
          <view class="">50000元</view>
        </view>
...
<script>
  ...
  export default {
    ...
    onShow() {
      PrizeApi.activityInfo({ id: this.id }).then(res => {
        console.log(res);
      })
    },
